...
<section class="team-section">
  <div class="container">
    ...
    <div class="section-header fade-in">
      ...
      <p class="section-subtitle">Meet our experienced healthcare professionals dedicated to providing exceptional medical care with cutting-edge treatments and compassionate service.</p>
    </div>
      ...
      <div class="specialty-card fade-in">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-card">
                    <div class="card-image">
                        <img src="{{asset('assets/images/team/team1.jpg')}}" 
                             alt="Dr. Norma Pedric" class="doctor-photo">
                    </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-card">
                    <div class="card-image">
                        <img src="{{asset('assets/images/team/team2.jpg')}}" 
                             alt="Dr. Sarah Johnson" class="doctor-photo">
                    </div>
                    <div class="card-overlay">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-card">
                    <div class="card-image">
                        <img src="{{asset('assets/images/team/team3.jpg')}}" 
                             alt="Dr. Michael Chen" class="doctor-photo">
                    </div>
                    <div class="card-overlay">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-card">
                    <div class="card-image">
                        <img src="{{asset('assets/images/team/team4.jpg')}}" 
                             alt="Dr. Emily Rodriguez" class="doctor-photo">
                    </div>
                    <div class="card-overlay">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-card">
                    <div class="card-image">
                        <img src="{{asset('assets/images/team/team5.jpg')}}" 
                             alt="Dr. David Wilson" class="doctor-photo">
                    </div>
                    <div class="card-overlay">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-card">
                    <div class="card-image">
                        <img src="{{asset('assets/images/team/team6.jpg')}}" 
                             alt="Dr. Lisa Thompson" class="doctor-photo">
                    </div>
                    <div class="card-overlay">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-card">
                    <div class="card-image">
                        <img src="{{asset('assets/images/team/team7.jpg')}}" 
                             alt="Dr. Robert Brown" class="doctor-photo">
                    </div>
                    <div class="card-overlay">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-card">
                    <div class="card-image">
                        <img src="{{asset('assets/images/team/team8.png')}}" 
                             alt="Dr. Amanda Davis" class="doctor-photo">
                    </div>
                    <div class="card-overlay">

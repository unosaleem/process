...
<div class="container-fluid">
  ...
  <div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
      <div class="welcome-text">
        <h4>Add Facility Section</h4>
      </div>
    </div>
    <div class="col-sm-6 d-flex justify-content-sm-end">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.facility.index') }}">Facility</a></li>
  ...
  <div class="card">
    <div class="card-header">
      <h4 class="card-title">Facility Page Details</h4>
    </div>
    <div class="card-body">
                        ...
                        <div class="basic-form custom_file_input">
                            <div class="input-group mb-3">
                                ...
                                <div class="custom-file">
                                    <input type="file" name="image" id="facility_image" class="custom-file-input" accept=".jpg,.jpeg,.png,.webp" required>
                                    <label class="custom-file-label" for="facility_image">Choose image</label>
                                </div>
                            </div>
                            <img id="imagePreview" class="preview-img" alt="Facility Image Preview">
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const facilityImage = document.getElementById('facility_image');
    const imagePreview = document.getElementById('imagePreview');

    if (facilityImage) {
        facilityImage.addEventListener('change', function() {
